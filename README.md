...
<h3 align="center">Software Developer | C/C++ • C# • Unity • Backend Foundations</h3>

<p align="center">
  Stuttgart, Germany • 
  <a href="mailto:popov.oleksandr2504@gmail.com">popov.oleksandr2504@gmail.com</a> •
  <a href="https://linkedin.com/in/oleksandr-popov" target="_blank">LinkedIn</a>
</p>
...
**Languages**: C, C++, C#  
**Game Dev**: Unity  
**Tools / DevOps**: Git, Docker, Nginx, Linux  
...
- Build stronger, cleaner Unity projects (architecture, patterns, maintainability)
- Improve C++ fundamentals (performance + memory)
- Expand backend skills (APIs + databases + deployment)
